...
class SsxResultsBrick(BaseWidget):
    def __init__(self, *args):
        ...
        # Graphic elements ----------------------------------------------------
        self.grid_widget = qt_import.QWidget(self)
        self.grid_table = qt_import.QTableWidget(self.grid_widget)
        self.grid_cell_label = qt_import.QLabel(
            "Selected grid cell: A1", self.grid_widget
        )
        self.chip_config_combo = qt_import.QComboBox(self)

        self.inverted_rows_cbox = qt_import.QCheckBox("Inverted rows", self.grid_widget)
        self.image_tracking_cbox = qt_import.QCheckBox("Live update", self.grid_widget)
        self.score_type_combo = qt_import.QComboBox(self.grid_widget)
        self.show_grid_dialog_button = qt_import.QPushButton(
            "Full grid view", self.grid_widget
        )

        self.comp_widget = qt_import.QWidget(self)
        self.comp_cell_label = qt_import.QLabel(
            "Selected compartment cell: A1", self.comp_widget
        )
        self.comp_table = qt_import.QTableWidget(self.comp_widget)
        self.hit_map_plot = PlotWidget(self.comp_widget)

        self.grid_dialog = qt_import.QDialog(self)
        ...
        self.save_grid_view_button = qt_import.QPushButton("Save", self.grid_dialog)
        self.save_grid_view_button.setFixedWidth(100)

        # Layout --------------------------------------------------------------
        _grid_vlayout = qt_import.QVBoxLayout(self.grid_widget)
        ...
        _comp_vlayout = qt_import.QVBoxLayout(self.comp_widget)
        ...
        _main_grid_dialog_vlayout = qt_import.QVBoxLayout(self.grid_dialog)
        ...
        # Other ---------------------------------------------------------------
        self.grid_table.setEditTriggers(qt_import.QAbstractItemView.NoEditTriggers)
        self.grid_table.setHorizontalScrollBarPolicy(qt_import.Qt.ScrollBarAlwaysOff)
        self.grid_table.setVerticalScrollBarPolicy(qt_import.Qt.ScrollBarAlwaysOff)
        self.grid_table.setMouseTracking(True)

        self.comp_table.setEditTriggers(qt_import.QAbstractItemView.NoEditTriggers)
        self.comp_table.setHorizontalScrollBarPolicy(qt_import.Qt.ScrollBarAlwaysOff)
        self.comp_table.setVerticalScrollBarPolicy(qt_import.Qt.ScrollBarAlwaysOff)
    ...
    def save_grid_view(self):
        ...
        file_types = "PNG (*.png)"
        filename = str(
            qt_import.QFileDialog.getSaveFileName(
                self,
...
class GridViewGraphicsItem(qt_import.QGraphicsItem):
    """
    ...
    def __init__(self):
        ...
        self.custom_pen = qt_import.QPen(qt_import.Qt.SolidLine)
        self.custom_pen.setWidth(1)
        self.custom_pen.setColor(qt_import.Qt.lightGray)

        self.custom_brush = qt_import.QBrush(qt_import.Qt.SolidPattern)
        brush_color = qt_import.Qt.white
    ...
    def paint(self, painter, option, widget):
        ...
        """
        if self.size_hole:
            self.custom_brush.setColor(qt_import.Qt.lightGray)
...
class GridViewOverlayItem(GridViewGraphicsItem):
    ...
    def paint(self, painter, option, widget):
        ...
        :return:
        """
        self.custom_brush.setColor(qt_import.Qt.blue)
        painter.setBrush(self.custom_brush)
